...
<head>
    ...
    <title>HBO-ICT School | Vakken</title>
...
<div class="container my-5">
    ...
    <header class="card-round p-4 mb-5 fade-in-up">
        <h1 class="section-heading">Vakken bij HBO-ICT School</h1>
        <p class="section-subtitle mb-0">
            Bekijk een overzicht van de belangrijkste vakken in onze praktijkgerichte ICT-opleiding.
        </p>
    </header>
    ...
    <footer class="site-footer text-center mt-5 pt-4 pb-3">
        <div class="container">
            <p class="mb-1 fw-semibold">HBO-ICT School | Vakken en praktijkonderdelen</p>
